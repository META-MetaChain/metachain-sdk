...
[metachain SDK](https://github.com/META-MetaChain/metachain-sdk) is a typescript library for client-side interactions with metachain. It provides common helper functionality as well as access to the underlying smart contract interfaces.
        
Below is a list of modules of the library. See the [tutorials](https://github.com/META-MetaChain/metachain-tutorials) for further examples of how to use these classes.
`
