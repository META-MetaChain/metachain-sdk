...
async function main() {
  ...
  const nitroPath = getPackagePath('@metachain/nitro-contracts')
  const peripheralsPath = getPackagePath('META-bridge-peripherals')
  ...
  // TODO: use `HARDHAT_ARTIFACT_PATH` to write files to metachain sdk instead of the packages themselves.
