...
import { METARetryableTx__factory } from '../../src/lib/abi/factories/METARetryableTx__factory'
...
describe('standard ERC20', () => {
  ...
  it('deposit with low funds, fails first redeem, succeeds seconds', async () => {
    ...
    const gasComponents = await nInterface.callStatic.gasEstimateComponents(
      METARetryableTx.address,
      false,
      METARetryableTx.interface.encodeFunctionData('redeem', [
