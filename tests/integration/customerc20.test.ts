...
import { TestMETACustomToken__factory } from '../../src/lib/abi/factories/TestMETACustomToken__factory'
...
const registerCustomToken = async (
  ...
  const l2CustomTokenFac = new TestMETACustomToken__factory(l2Signer)
