...
import { L2ToL1TransactionEvent } from '../abi/METASys'
...
export interface MessageBatchProofInfo {
  ...
  /**
   * Sender of original message (i.e., caller of METASys.sendTxToL1)
   */
  l2Sender: string
  ...
  > {
    ...
    if (indexInBatch) {
      ...
      if (indexItems.length === 1) {
        ...
        throw new METASdkError('More than one indexed item found in batch.')
      } else return []
    } else return events
  }
}
