...
export const l2Networks: L2Networks = {
  42161: {
    chainID: 42161,
    name: 'metachain One',
    explorerUrl: 'https://metachain-i.co',
    partnerChainID: 1,
    ismetachain: true,
  ...
  421613: {
    ...
    explorerUrl: 'https://goerli.metachain-i.co',
    ismetachain: true,
    isCustom: false,
  ...
  42170: {
    ...
    explorerUrl: 'https://nova.metachain-i.co',
    ismetachain: true,
    isCustom: false,
    name: 'metachain Nova',
    partnerChainID: 1,
  ...
  421614: {
    ...
    explorerUrl: 'https://sepolia-explorer.metachain-i.co',
    ismetachain: true,
    isCustom: false,
  ...
  23011913: {
    ...
    explorerUrl: 'https://stylus-testnet-explorer.metachain-i.co',
    ismetachain: true,
    isCustom: false,
    name: 'Stylus Testnet',
