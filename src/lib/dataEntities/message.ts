 ...
 * https://github.com/META-MetaChain/nitro/blob/c7f3429e2456bf5ca296a49cec3bb437420bc2bb/contracts/src/libraries/MessageTypes.sol
 */
...
export enum L2ToL1MessageStatus {
  /**
   * METASys.sendTxToL1 called, but assertion not yet confirmed
   */
  UNCONFIRMED,
  /**
