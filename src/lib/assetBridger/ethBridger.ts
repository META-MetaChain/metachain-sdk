...
import { MissingProviderMETASdkError } from '../dataEntities/errors'
...
> {
  ...
  public async getWithdrawalRequest(
    ...
    const iMETASys = METASys__factory.createInterface()
    const functionData = iMETASys.encodeFunctionData('withdrawEth', [
